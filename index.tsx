...
export const BANNED_VOCAL_KEYWORDS = [
  'piano', 'instrumental', 'karaoke', 'cover', 'remix', 'lofi', 'lo-fi',
  'acoustic cover', 'deep vocal', 'vocal cover', 'tribute', 'version',
  'edit', 'sped up', 'slowed', 'reverb', 'nightcore', '8d', '8d audio',
  'background', 'game', 'game music', 'soundtrack', 'beat', 'mashup',
  'ai cover', 'ai music', 'slowed + reverb', 'nightcore version',
  'piano cover', 'instrumental version', 'piano solo', 'deep vocal version'
];

export function scoreTrackForGenre(track: PlaylistItem, targetGenreKey: string): number {
  if (!track || !track.genreKey) return -1000;
  if (track.genreKey !== targetGenreKey) return -1000;

  const combined = `${track.title || ''} ${track.artist || ''} ${track.badge || ''}`.toLowerCase();

  if (['vpop', 'usuk', 'kpop'].includes(targetGenreKey)) {
    for (const word of BANNED_VOCAL_KEYWORDS) {
  ...
  if (targetGenreKey === 'khongloi') {
    if (combined.includes('game music') || combined.includes('mashup')) return -1000;
    return 100;
  }

  if (targetGenreKey === 'thien') {
    if (combined.includes('kpop') || combined.includes('vpop')) return -1000;
    return 100;
  }

  if (targetGenreKey === 'cafesax') {
    if (combined.includes('game music')) return -1000;
    return 100;
  }
...
export const MULTI_GENRE_CATALOG: PlaylistItem[] = [
  // 1. NHẠC VIỆT (V-Pop, Ballad, Trữ Tình có giọng hát ca sĩ - Nguồn Nhaccuatui.com)
  { id: 'vp-1', title: 'Nơi Này Có Anh', artist: 'Sơn Tùng M-TP', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', badge: '🇻🇳 V-Pop Hit', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/bai-hat/noi-nay-co-anh-son-tung-m-tp.html' },
  { id: 'vp-2', title: 'Sau Lời Khước Từ', artist: 'Phan Mạnh Quỳnh', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', badge: '🇻🇳 Nhạc Phim Mai', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/bai-hat/sau-loi-khuoc-tu-phan-manh-quynh.html' },
  { id: 'vp-3', title: 'Tháng Mấy Em Nhớ Anh', artist: 'Hà Anh Tuấn', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', badge: '🇻🇳 Single Hit', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-4', title: 'Tháng Tư Là Lời Nói Dối Của Anh', artist: 'Hà Anh Tuấn', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', badge: '🇻🇳 V-Pop Ballad', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-5', title: 'Nàng Thơ', artist: 'Hoàng Dũng', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', badge: '🇻🇳 Nàng Thơ', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-6', title: 'Đưa Tiến Em', artist: 'Vũ & Đen Vâu', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3', badge: '🇻🇳 Indie Việt', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-7', title: 'Cơn Mưa Tình Yêu', artist: 'Hà Anh Tuấn & Phương Linh', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3', badge: '🇻🇳 Song Ca V-Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-8', title: 'Hơn Cả Yêu', artist: 'Đức Phúc', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3', badge: '🇻🇳 Love Ballad', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-9', title: 'Ngày Đầu Tiên', artist: 'Đức Phúc', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3', badge: '🇻🇳 V-Pop Ballad', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-10', title: 'Diễm Xưa', artist: 'Khánh Ly', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3', badge: '🇻🇳 Nhạc Trịnh', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-11', title: 'Bước Qua Nhau', artist: 'Vũ', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3', badge: '🇻🇳 Indie V-Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-12', title: 'Vì Anh Đâu Biết', artist: 'Madihu ft. Vũ', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3', badge: '🇻🇳 Chill V-Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-13', title: 'Lạc Trôi', artist: 'Sơn Tùng M-TP', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3', badge: '🇻🇳 V-Pop Hit', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-14', title: 'Cắt Đôi Nỗi Sầu', artist: 'Tăng Duy Tân', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3', badge: '🇻🇳 Trending V-Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-15', title: 'Thắc Mắc', artist: 'Thịnh Suy', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-15.mp3', badge: '🇻🇳 Single Vibe', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-16', title: 'Ước Gì', artist: 'Mỹ Tâm', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-16.mp3', badge: '🇻🇳 Mỹ Tâm Hit', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-17', title: 'Có Chắc Yêu Là Đây', artist: 'Sơn Tùng M-TP', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', badge: '🇻🇳 V-Pop Hit', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-18', title: 'Yêu Lại Từ Đầu', artist: 'Khắc Việt', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', badge: '🇻🇳 Hit Huyền Thoại', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-19', title: 'Không Thể Cùng Nhau Suốt Kiếp', artist: 'Hòa Minzy', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', badge: '🇻🇳 Ballad Hit', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-20', title: 'Phía Sau Một Cô Gái', artist: 'Soobin Hoàng Sơn', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', badge: '🇻🇳 Soobin Ballad', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-21', title: 'Bùa Yêu', artist: 'Bích Phương', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', badge: '🇻🇳 Bích Phương Hit', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-22', title: 'Sóng Gió', artist: 'Jack & K-ICM', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3', badge: '🇻🇳 Sóng Gió', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-23', title: 'Anh Nhà Ở Đâu Thế', artist: 'AMEE', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3', badge: '🇻🇳 AMEE Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-24', title: 'Người Ấy', artist: 'Trịnh Thăng Bình', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3', badge: '🇻🇳 Ballad Quen Thuộc', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'vp-25', title: 'Em Mới Là Người Yêu Anh', artist: 'Mimi & Min', category: 'vpop', genreKey: 'vpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3', badge: '🇻🇳 V-Pop Trending', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },

  // 2. ÂU - MỸ (US-UK Vocal Hits - Nguồn Nhaccuatui.com)
  { id: 'us-1', title: 'Shape of You', artist: 'Ed Sheeran', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3', badge: '🌎 US-UK Hit', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/playlist/O0A128j8c8m' },
  { id: 'us-2', title: 'Perfect', artist: 'Ed Sheeran', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3', badge: '🌎 Love Song', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/playlist/O0A128j8c8m' },
  { id: 'us-3', title: 'Until I Found You', artist: 'Stephen Sanchez', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3', badge: '🌎 Retro US-UK', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/playlist/O0A128j8c8m' },
  { id: 'us-4', title: 'Hotel California', artist: 'Eagles', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3', badge: '🌎 Classic Rock', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/playlist/O0A128j8c8m' },
  { id: 'us-5', title: 'Shallow', artist: 'Lady Gaga & Bradley Cooper', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-15.mp3', badge: '🌎 Movie OST', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/playlist/O0A128j8c8m' },
  { id: 'us-6', title: 'Someone Like You', artist: 'Adele', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-16.mp3', badge: '🌎 Soul Vocal', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/playlist/O0A128j8c8m' },
  { id: 'us-7', title: 'Easy On Me', artist: 'Adele', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', badge: '🌎 Adele Vocal', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-8', title: 'All of Me', artist: 'John Legend', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', badge: '🌎 Love Song', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-9', title: 'Counting Stars', artist: 'OneRepublic', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', badge: '🌎 Folk Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-10', title: 'Memories', artist: 'Maroon 5', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', badge: '🌎 Pop Ballad', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-11', title: 'Thinking Out Loud', artist: 'Ed Sheeran', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', badge: '🌎 Ed Sheeran', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-12', title: 'Stay With Me', artist: 'Sam Smith', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3', badge: '🌎 Soul Gospel', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-13', title: 'Attention', artist: 'Charlie Puth', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3', badge: '🌎 Pop Lounge', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-14', title: 'See You Again', artist: 'Wiz Khalifa & Charlie Puth', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3', badge: '🌎 Furious OST', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-15', title: 'As It Was', artist: 'Harry Styles', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3', badge: '🌎 Retro Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-16', title: 'Anti-Hero', artist: 'Taylor Swift', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3', badge: '🌎 Taylor Swift', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-17', title: 'Blinding Lights', artist: 'The Weeknd', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3', badge: '🌎 Synth Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-18', title: 'Flowers', artist: 'Miley Cyrus', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3', badge: '🌎 Disco Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-19', title: 'Stay', artist: 'Justin Bieber & The Kid LAROI', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3', badge: '🌎 Chart Topper', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-20', title: 'Bad Habits', artist: 'Ed Sheeran', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3', badge: '🌎 Ed Dance Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-21', title: 'Let Her Go', artist: 'Passenger', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-15.mp3', badge: '🌎 Folk Hit', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-22', title: 'Someone You Loved', artist: 'Lewis Capaldi', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-16.mp3', badge: '🌎 Soulful Hit', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-23', title: 'Drivers License', artist: 'Olivia Rodrigo', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', badge: '🌎 Olivia Ballad', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-24', title: 'Say You Won t Let Go', artist: 'James Arthur', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', badge: '🌎 James Ballad', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'us-25', title: 'Just the Way You Are', artist: 'Bruno Mars', category: 'restaurant', genreKey: 'usuk', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', badge: '🌎 Bruno Classic', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },

  // 3. HÀN QUỐC (K-Pop & Movie OST Vocals - Nguồn Nhaccuatui.com)
  { id: 'kp-1', title: 'Stay With Me', artist: 'Chanyeol & Punch', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', badge: '🇰🇷 Goblin OST', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/playlist/L8Le1DOh8TQB' },
  { id: 'kp-2', title: 'Everytime', artist: 'Chen & Punch', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', badge: '🇰🇷 Hậu Duệ Mặt Trời', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/playlist/L8Le1DOh8TQB' },
  { id: 'kp-3', title: 'Spring Day', artist: 'BTS', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3', badge: '🇰🇷 BTS Vocal', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/playlist/L8Le1DOh8TQB' },
  { id: 'kp-4', title: 'Flower', artist: 'Blackpink Jisoo', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3', badge: '🇰🇷 K-Pop Vocal', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/playlist/L8Le1DOh8TQB' },
  { id: 'kp-5', title: 'You Are My Everything', artist: 'Gummy', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3', badge: '🇰🇷 K-Drama OST', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/playlist/L8Le1DOh8TQB' },
  { id: 'kp-6', title: 'Say Yes', artist: 'Loco & Punch', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3', badge: '🇰🇷 Moon Lovers', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-7', title: 'All About You', artist: 'Taeyeon', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3', badge: '🇰🇷 Hotel Del Luna', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-8', title: 'Sunset', artist: 'Davichi', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3', badge: '🇰🇷 Hạ Cánh Nơi Anh', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-9', title: 'Start Over', artist: 'Gaho', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3', badge: '🇰🇷 Itaewon Class', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-10', title: 'Beautiful', artist: 'Crush', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3', badge: '🇰🇷 Goblin OST', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-11', title: 'Best Luck', artist: 'Chen (EXO)', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3', badge: '🇰🇷 EXO Vocal', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-12', title: 'Aloha', artist: 'Jo Jung Suk', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-15.mp3', badge: '🇰🇷 Hospital Playlist', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-13', title: 'Through The Night', artist: 'IU', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-16.mp3', badge: '🇰🇷 IU Night', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-14', title: 'Hype Boy', artist: 'NewJeans', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', badge: '🇰🇷 NewJeans Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-15', title: 'Eleven', artist: 'IVE', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', badge: '🇰🇷 IVE Single', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-16', title: 'Palette', artist: 'IU ft. G-Dragon', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', badge: '🇰🇷 IU & GD', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-17', title: 'Love Scenario', artist: 'iKON', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', badge: '🇰🇷 iKON Hit', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-18', title: 'Eight', artist: 'IU ft. SUGA of BTS', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', badge: '🇰🇷 IU & SUGA', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-19', title: 'Dynamite', artist: 'BTS', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3', badge: '🇰🇷 BTS Disco', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-20', title: 'As If It s Your Last', artist: 'BLACKPINK', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3', badge: '🇰🇷 BLACKPINK', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-21', title: 'What Is Love', artist: 'TWICE', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3', badge: '🇰🇷 TWICE Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-22', title: 'Psycho', artist: 'Red Velvet', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3', badge: '🇰🇷 Red Velvet', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-23', title: 'I Will Go to You Like the First Snow', artist: 'Ailee', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3', badge: '🇰🇷 Ailee OST', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-24', title: 'Good Day', artist: 'IU', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3', badge: '🇰🇷 IU Classic', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kp-25', title: 'Weekend', artist: 'Taeyeon', category: 'restaurant', genreKey: 'kpop', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3', badge: '🇰🇷 Taeyeon Pop', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },

  // 4. KHÔNG LỜI (Piano Acoustic & Classical Masterpieces - Nguồn Nhaccuatui.com)
  ...
  { id: 'kl-11', title: 'Secret', artist: 'Jay Chou Piano', category: 'restaurant', genreKey: 'khongloi', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3', badge: '🎹 Jay Chou Piano', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kl-12', title: 'Autumn Leaves', artist: 'Piano Jazz Unplugged', category: 'restaurant', genreKey: 'khongloi', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3', badge: '🎹 Autumn Piano', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kl-13', title: 'Memory', artist: 'Andrew Lloyd Webber', category: 'restaurant', genreKey: 'khongloi', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-15.mp3', badge: '🎹 Cello & Piano', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kl-14', title: 'Song From A Secret Garden', artist: 'Secret Garden Duo', category: 'restaurant', genreKey: 'khongloi', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-16.mp3', badge: '🎻 Violin & Piano', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kl-15', title: 'Time To Say Goodbye', artist: 'Symphonic Master', category: 'restaurant', genreKey: 'khongloi', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', badge: '🎹 Symphonic Duo', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kl-16', title: 'Experience', artist: 'Ludovico Einaudi', category: 'restaurant', genreKey: 'khongloi', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', badge: '🎹 Einaudi Piano', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kl-17', title: 'Nuvole Bianche', artist: 'Ludovico Einaudi', category: 'restaurant', genreKey: 'khongloi', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', badge: '🎹 White Clouds Piano', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kl-18', title: 'Butterfly Waltz', artist: 'Brian Crain', category: 'restaurant', genreKey: 'khongloi', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', badge: '🎹 Brian Crain', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kl-19', title: 'Autumn Rose', artist: 'Ernesto Cortazar', category: 'restaurant', genreKey: 'khongloi', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', badge: '🎹 Cortazar Piano', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'kl-20', title: 'Lysistrata', artist: 'Giovanni Marradi', category: 'restaurant', genreKey: 'khongloi', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3', badge: '🎹 Marradi Master', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },

  // 5. THIỀN & LOFI (Spa & Relax 432Hz Tĩnh Tâm - Nguồn Nhaccuatui.com)
  ...
  { id: 'th-6', title: 'Delta Waves Sleep & Relaxation 432Hz', artist: 'Delta Waves Relax', category: 'restaurant', genreKey: 'thien', url: 'https://ia800302.us.archive.org/1/items/FourSeasonsSpring_429/AntonioVivaldi-FourSeasonsSpring.mp3', badge: '🧘 Sóng Não Delta', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-7', title: 'Forest Birds & Soft Acoustic Guitar 432Hz', artist: 'Nature Acoustics', category: 'restaurant', genreKey: 'thien', url: 'https://ia800303.us.archive.org/11/items/TheBlueDanube_128/JohannStraussII-TheBlueDanube.mp3', badge: '🧘 Tiếng Chim Rừng', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-8', title: 'Ocean Waves & Gentle Harp Meditation', artist: 'Harp Meditation', category: 'restaurant', genreKey: 'thien', url: 'https://ia800300.us.archive.org/4/items/FlightOfTheBumblebee_877/NikolaiRimsky-Korsakov-FlightOfTheBumblebee.mp3', badge: '🧘 Đàn Tơ Rung 432Hz', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-9', title: 'Zen Garden Bamboo Water Fountain 432Hz', artist: 'Zen Water Sounds', category: 'restaurant', genreKey: 'thien', url: 'https://ia800305.us.archive.org/12/items/Greensleeves_247/Anonymous-Greensleeves.mp3', badge: '🧘 Suối Trúc Zen', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-10', title: 'Mindful Breathing Bell & Ambient Pad', artist: 'Mindfulness Bell', category: 'restaurant', genreKey: 'thien', url: 'https://cdn.pixabay.com/download/audio/2022/11/06/audio_c97a8e7e13.mp3', badge: '🧘 Chuông Chánh Niệm', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-11', title: 'Sông Nước Miền Tây & Tiếng Đàn Tranh 432Hz', artist: 'Đàn Tranh Thiền Định', category: 'restaurant', genreKey: 'thien', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3', badge: '🧘 Đàn Tranh 432Hz', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-12', title: 'Lofi Rain Cafe Ambient Vibe', artist: 'Lofi Chill Cafe', category: 'restaurant', genreKey: 'thien', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3', badge: '🧘 Lofi Chờ Mưa', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-13', title: 'Tiếng Sóng Biển & Đàn Bầu Ru Hồn 432Hz', artist: 'Đàn Bầu Việt Nam', category: 'restaurant', genreKey: 'thien', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3', badge: '🧘 Đàn Bầu 432Hz', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-14', title: 'Thiền Định Buổi Trưa Quán Cơm Út Trinh 432Hz', artist: 'Thiền Định Bữa Ăn', category: 'restaurant', genreKey: 'thien', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3', badge: '🧘 Thiền Bữa Trưa', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-15', title: 'Hoàng Hôn Miền Tây & Sáo Trúc Thiền 432Hz', artist: 'Sáo Trúc Đồng Quê', category: 'restaurant', genreKey: 'thien', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3', badge: '🧘 Sáo Trúc Thiền', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-16', title: 'Tĩnh Tâm Chiều Quán Cơm Út Trinh 432Hz', artist: 'Tĩnh Tâm Bữa Chiều', category: 'restaurant', genreKey: 'thien', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3', badge: '🧘 Tĩnh Tâm Chiều', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-17', title: 'Đêm An Yên & Tiếng Sáo Trúc 432Hz', artist: 'Sáo Trúc Đêm', category: 'restaurant', genreKey: 'thien', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3', badge: '🧘 Đêm An Yên', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-18', title: 'Spa Lotus Deep Healing Ambient 432Hz', artist: 'Lotus Spa Healing', category: 'restaurant', genreKey: 'thien', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3', badge: '🧘 Lotus Ambient', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-19', title: 'Zen Meditation Bell & Stream 432Hz', artist: 'Zen Bell Stream', category: 'restaurant', genreKey: 'thien', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-15.mp3', badge: '🧘 Zen Bell Stream', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'th-20', title: 'Thư Giãn Đầu Óc & Sóng Não Beta 432Hz', artist: 'Mindful Soundscapes', category: 'restaurant', genreKey: 'thien', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-16.mp3', badge: '🧘 Sóng Beta 432Hz', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },

  // 6. CAFE & SAXOPHONE (Jazz & Restaurant Atmosphere - Nguồn Nhaccuatui.com)
  ...
  { id: 'cs-3', title: 'Acoustic Guitar Thư Giãn Chiều Quán Cơm', artist: 'Hòa Tấu Guitar Unplugged', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', badge: '🎸 Acoustic Cafe', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com/playlist/O0A128j8c8m' },
  { id: 'cs-4', title: 'Careless Whisper - Kenny G Saxophone Solo', artist: 'Kenny G Saxophone', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', badge: '🎷 Kenny G Sax', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-5', title: 'Loving You - Kenny G Smooth Saxophone', artist: 'Kenny G', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', badge: '🎷 Kenny G Love', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-6', title: 'The Moment - Kenny G Smooth Sax Collection', artist: 'Kenny G', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3', badge: '🎷 The Moment', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-7', title: 'Songbird - Kenny G Jazz Collection', artist: 'Kenny G', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3', badge: '🎷 Songbird Jazz', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-8', title: 'What A Wonderful World - Saxophone & Organ', artist: 'Jazz Quartet Lounge', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3', badge: '🎷 Jazz Classic', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-9', title: 'Autumn in New York - Smooth Jazz Quartet', artist: 'Smooth Jazz Ensemble', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3', badge: '🎷 Autumn Jazz', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-10', title: 'Fly Me To The Moon - Saxophone Lounge Duo', artist: 'Saxophone Lounge', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3', badge: '🎷 Moon Jazz', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-11', title: 'Desafinado - Bossa Nova Saxophone Solo', artist: 'Bossa Nova Trio', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3', badge: '🎷 Bossa Nova', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-12', title: 'Girl From Ipanema - Bossa Nova Guitar & Sax', artist: 'Bossa Sax Lounge', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3', badge: '🎷 Ipanema Sax', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-13', title: 'Misty - Jazz Piano & Tenor Sax Unplugged', artist: 'Tenor Sax Unplugged', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-11.mp3', badge: '🎷 Tenor Sax', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-14', title: 'Smooth Operator - Saxophone Cafe Lounge', artist: 'Smooth Operator Duo', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-12.mp3', badge: '🎷 Cafe Operator', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-15', title: 'Afternoon Tea - Unplugged Acoustic & Sax', artist: 'Acoustic Sax Vibe', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3', badge: '🎷 Afternoon Tea', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-16', title: 'Bossa Nova Sunset Cafe & Saxophone', artist: 'Bossa Nova Sunset', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3', badge: '🎷 Bossa Sunset', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-17', title: 'Coffee Time Saxophone & Piano Lounge', artist: 'Coffee Lounge Duo', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-15.mp3', badge: '🎷 Coffee Sax', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-18', title: 'Soft Saxophone Ballad Afternoon Relax', artist: 'Soft Sax Collection', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-16.mp3', badge: '🎷 Soft Sax Ballad', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-19', title: 'Blue Bossa Saxophone & Jazz Organ', artist: 'Blue Bossa Quartet', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3', badge: '🎷 Blue Bossa', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' },
  { id: 'cs-20', title: 'Unforgettable Saxophone & Acoustic Cafe', artist: 'Unforgettable Sax Duo', category: 'restaurant', genreKey: 'cafesax', url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3', badge: '🎷 Unforgettable Sax', sourceType: 'nhaccuatoi', sourceLabel: 'Nguồn Nhaccuatui.com', nctLink: 'https://www.nhaccuatui.com' }
];
...
export function getUsedTrackIdsMap(): Record<string, string[]> {
  try {
    ...
    console.warn("Could not parse used track ids from localStorage:", e);
  }
  return { vpop: [], usuk: [], kpop: [], khongloi: [], thien: [], cafesax: [] };
}

export function saveUsedTrackIdsMap(map: Record<string, string[]>) {
  try {
    localStorage.setItem(USED_TRACKS_KEY, JSON.stringify(map));
  } catch (e) {
    console.warn("Could not save used track ids to localStorage:", e);
  }
}
...
// Fetch new batches for all 6 genres combined
export function fetchAllGenresNhacCuaToiBatch(targetCountPerGenre: number = 5): PlaylistItem[] {
  console.log(`[Music] --- FETCHING BRAND NEW BATCHES FOR ALL 6 TABS ---`);
  const genres: ('vpop' | 'usuk' | 'kpop' | 'khongloi' | 'thien' | 'cafesax')[] = [
    'vpop', 'usuk', 'kpop', 'khongloi', 'thien', 'cafesax'
  ];
  const allBatches = genres.map(g => fetchNhacCuaToiBatch(g, targetCountPerGenre));
...
const HomePage = ({ menu, heroSlides, isLoading, supabase, currentTheme, onThemeChange, menuImageUrl, pollData, onVote }: any) => {
  ...
  const handlePickRandomTrack = useCallback((targetGenreKey?: string) => {
    ...
    const effectiveGenre = (!targetGenreKey || targetGenreKey === 'all') 
      ...
      : targetGenreKey;
    const newBatch = fetchNhacCuaToiBatch(effectiveGenre as any, 5);
    setSessionCatalog(prev => {
      const others = prev.filter(t => t.genreKey !== effectiveGenre);
      return [...others, ...newBatch];
    });
...
const AdminPanel = ({ menu, setMenu, heroSlides, setHeroSlides, onSave, supabase, theme, onThemeChange, menuImageUrl, setMenuImageUrl, pollData, onSavePoll }: any) => {
  ...
  const [adminVPopTracks, setAdminVPopTracks] = useState<PlaylistItem[]>(() => {
    const vpopList = MULTI_GENRE_CATALOG.filter(t => t.genreKey === 'vpop');
    const shuffled = [...vpopList].sort(() => 0.5 - Math.random());
